...
public class MainAlgorithm {
    ...
    public MainAlgorithm(AlgorithmParams params, City city, Random rnd){
        ...
        solutionEstimater = new SolutionEstimater(city, params.notDeliveredPunishment, params.outOfWorkingTimePunishment, params.deltaStartWorkingTime, params.outOfWorkingTimePunishment);
