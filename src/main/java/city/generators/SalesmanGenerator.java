...
public class SalesmanGenerator {

    public SalesmanGenerator(SalesmanGeneratorParams params, Random rnd) {
        this.params = params;
        this.rnd = rnd;
    }
    ...
    public Salesman generateOne(){
        ...
        return new Salesman(weight, costPerTime, costPerDistance, workingTime);
    }
}
