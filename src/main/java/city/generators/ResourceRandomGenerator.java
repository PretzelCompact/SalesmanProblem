...
public class ResourceRandomGenerator {

    public ResourceRandomGenerator(ResourceGeneratorParams params, Random rnd) {
        this.params = params;
        this.rnd = rnd;
    }
    ...
    public Resource generateOne(){
        ...
        double lowerDeliveryTime = generateRandomDouble(params.minLowerDeliveryTime, params.maxLowerDeliveryTime);
        double upperDeliveryTime = generateRandomDouble(params.minUpperDeliveryTime, params.maxUpperDeliveryTime);
        ...
        return new Resource(weight, startVertex, finishVertex, lowerDeliveryTime, upperDeliveryTime);
    }
}
